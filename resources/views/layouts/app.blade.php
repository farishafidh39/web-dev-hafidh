...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('templates/admin/assets/img/apple-icon.png') }}">
    <title>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('templates/admin/assets/css/argon-dashboard.css') }}" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html "
                target="_blank">
                <img src="{{ asset('templates/admin/assets/img/logo-ct-dark.png') }}" width="26px" height="26px"
    ...
    <script src="{{ asset('templates/admin/assets/js/argon-dashboard.min.js?v=2.1.0') }}"></script>
</body>
